...
public class PitchActivity2 extends AppCompatActivity {
...
//        theChord = ChordBuilder.buildChordContainingPitch(pitchIndex);
    ...
    public void setSpinners(){
        CustomSpinner cs1 = (CustomSpinner)findViewById(R.id.customSpinner);
        CustomSpinner cs2 = (CustomSpinner)findViewById(R.id.customSpinner2);
    ...
    public void updateRecord() {
        TextView record = (TextView) findViewById(R.id.textView14);
            ...
            public void onShow(DialogInterface dialogInterface) {
                ...
                b1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        PitchActivity.playPitch(pitchIndex);
                    }
                });
    ...
    public void playPitch(View view) {
        PitchActivity.playPitch(pitchIndex);
    }
